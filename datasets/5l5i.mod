...
param transp_cost := S1 T11 802  T11 D1 501 T11 D2 829 T11 D3 655;

param supply_demand (tr): S1 T11 D1 D2 D3 dummy_sup dummy_dem := 
    I1 400 0 -120 -130 -250 100 0
    I2 400 0 -170 -130 -200 100 0
    I3 400 0 -120 -170 -210 100 0
    I4 400 0 -130 -180 -190 100 0
    I5 400 0 -130 -140 -230 100 0
;

param node_capacity := S1 2000 T11 2754 D1 670 D2 750 D3 1080;
